    ...
    if (o == 37) {
        ...
        if (GTYPE == 10 || GTYPE == 7) {
            for (var i = 0; i < cc; i++) {
                ...
                if ((i + istart-1) > 2 * num - 1 && (i + istart)%2==1) {
                    $("input[name='tbNum[]']").eq(i).val(parseInt(data[i]));
                    $('input[name=chk]').eq(i).prop("checked", true);
                }
            }
            ...
            for (var i = 0; i < cc; i++) {
                if (GTYPE == 22) {
                    if ((i + istart) <= num + 3 && (i + istart)%2==1) {
                        $("input[name='tbNum[]']").eq(i).val(parseInt(data[i]));
                        $('input[name=chk]').eq(i).prop("checked", true);
                    }

                    if ((i + istart) > 2 * num + 2 && (i + istart)%2==1) {
                        $("input[name='tbNum[]']").eq(i).val(parseInt(data[i]));
                        $('input[name=chk]').eq(i).prop("checked", true);
                    }
                    ...
                    if ((i + istart) > 2 * num + 1 && (i + istart)%2==1) {
                        $("input[name='tbNum[]']").eq(i).val(parseInt(data[i]));
                        $('input[name=chk]').eq(i).prop("checked", true);
                    }
                }else {
    ...
    if (o == 38) {
        ...
        if (GTYPE == 10 || GTYPE == 7) {
            ...
            for (var i = 0; i < cc; i++) {
                ...
                if ((i + istart-1) > 2 * num - 1 && (i + istart)%2==0) {
                    $("input[name='tbNum[]']").eq(i).val(parseInt(data[i]));
                    $('input[name=chk]').eq(i).prop("checked", true);
                }
            }
            ...
            for (var i = 0; i < cc; i++) {
                if (GTYPE == 22) {
                    if ((i + istart) > 2 * num + 2 && (i + istart)%2==0) {
                        $("input[name='tbNum[]']").eq(i).val(parseInt(data[i]));
                        $('input[name=chk]').eq(i).prop("checked", true);
                    }
                    ...
                    if ((i + istart) > 2 * num + 1 && (i + istart)%2==0) {
                        $("input[name='tbNum[]']").eq(i).val(parseInt(data[i]));
                        $('input[name=chk]').eq(i).prop("checked", true);
                    }
                    if ((i + istart) <= num && (i + istart)%2==0) {
