        ...
        <div class="ibox-content mt20">
          <form  id="creditform"> 
            ...
            <div class="form-group">
              ...
              <span class="control-span"><?php if(!(empty($user['coin']) || (($user['coin'] instanceof \think\Collection || $user['coin'] instanceof \think\Paginator ) && $user['coin']->isEmpty()))): ?><?php echo number_format($user['coin']); else: ?>0<?php endif; ?></span>
            </div>
            <div class="form-group">
              <label class="control-label">您的银行存款：</label>
              <span class="control-span"><?php if(!(empty($user['bank']) || (($user['bank'] instanceof \think\Collection || $user['bank'] instanceof \think\Paginator ) && $user['bank']->isEmpty()))): ?><?php echo number_format($user['bank']); else: ?>0<?php endif; ?></span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label"><?php echo $safe_q; ?></label>
