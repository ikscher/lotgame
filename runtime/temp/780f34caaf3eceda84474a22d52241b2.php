<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\mywork\lotgame\public/../app/agent\view\operate\recharge.html";i:1553613488;s:49:"D:\mywork\lotgame\app\agent\view\public\left.html";i:1553613559;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="utf-8">
	...
	<form class="layui-form" action="">
	  <div class="layui-form-item">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" name="title" required  lay-verify="required" placeholder="请输入用户UID" autocomplete="off" class="layui-input"><a href="">查询用户</a>
	    </div>
	  </div>
	  ...
	  <div class="layui-form-item">
	    <div class="layui-input-block">
	      <button class="layui-btn" lay-submit lay-filter="formDemo">确认充值</button>
