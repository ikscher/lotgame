<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:59:"D:\mywork\lotgame\public/../app/front\view\shop\detail.html";i:1555600351;s:51:"D:\mywork\lotgame\app\front\view\public\header.html";i:1554734502;s:51:"D:\mywork\lotgame\app\front\view\public\footer.html";i:1554377533;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				    ...
				    <table>
					    ...
					    <tr>
							<?php if(is_array($grade) || $grade instanceof \think\Collection || $grade instanceof \think\Paginator): if( count($grade)==0 ) : echo "" ;else: foreach($grade as $key=>$vo_): ?>
							    <td><font class="money money_bg"><?php if($vo_['grade'] == 0): ?><?php echo $prize['price']*$c1; else: ?><?php echo $prize['price']*$c2; endif; ?></font></td>
							<?php endforeach; endif; else: echo "" ;endif; ?>
						</tr>
				    </table>
				    <input type='hidden' name="prize_id" value="<?php echo $id; ?>" />
				    <button  lay-submit lay-filter="order" class="gbtn">确认兑奖</button> <!--onclick="javascript:window.location.href='/shop/order?id=<?php echo $id; ?>'"-->
	            </div>        
	        </div>
	        <div class="blank"> </div>
		      <div>
