<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\mywork\lotgame\public/../app/admin\view\usergrade\publish.html";i:1552912333;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <form class="layui-form" id="admin">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="max-width:500px;">
          <input name="exp_min" autocomplete="off" placeholder="标签之间用,隔开" class="layui-input" type="text" <?php if(!(empty($usergrade['exp_min']) || (($usergrade['exp_min'] instanceof \think\Collection || $usergrade['exp_min'] instanceof \think\Paginator ) && $usergrade['exp_min']->isEmpty()))): ?>value="<?php echo $usergrade['exp_min']; ?>"<?php endif; ?>>
        </div>
      </div>
