  ...
  <div class="tplay-body-div">
    ...
    <form class="layui-form" id="admin">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input name="base_num" autocomplete="off" placeholder="请输入" class="layui-input" type="text" <?php if(!(empty($signinconfig['base_num']) || (($signinconfig['base_num'] instanceof \think\Collection || $signinconfig['base_num'] instanceof \think\Paginator ) && $signinconfig['base_num']->isEmpty()))): ?>value="<?php echo $signinconfig['base_num']; ?>"<?php else: ?>value="0"<?php endif; ?>>
        </div>
      ...
      <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="checkbox" name="status" lay-filter="status" <?php if(!(empty($signinconfig['status']) || (($signinconfig['status'] instanceof \think\Collection || $signinconfig['status'] instanceof \think\Paginator ) && $signinconfig['status']->isEmpty()))): ?>checked value="1"<?php else: ?> value="0"<?php endif; ?>>
          </div>
      </div>
      ...
      layui.use(['layer', 'form'], function() {
          ...
          $(window).on('load', function() {
              form.on('submit(admin)', function(data) {
                  $.ajax({
                      url:"<?php echo url('admin/signinconfig/publish'); ?>",
