<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"D:\mywork\lotgame\public/../app/admin\view\prize\publish.html";i:1552656138;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body style="padding:10px;">
  <div class="tplay-body-div">
    ...
    <form class="layui-form" id="admin">
      ...
      <div class="layui-form-item">
        <label class="layui-form-label">兑换原价</label>
        <div class="layui-input-block" style="max-width:300px;">
          <input name="units" autocomplete="off"  class="layui-input layui-input-fix" type="text" <?php if(!(empty($prize['units']) || (($prize['units'] instanceof \think\Collection || $prize['units'] instanceof \think\Paginator ) && $prize['units']->isEmpty()))): ?>value="<?php echo $prize['units']; ?>"<?php endif; ?>>（金币）
        </div>
      </div>
      ...
      <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block" style="max-width:1000px;">
          <textarea placeholder="请输入内容" class="layui-textarea" name="desc" id="container" style="border:0;padding:0"><?php if(!(empty($prize['desc']) || (($prize['desc'] instanceof \think\Collection || $prize['desc'] instanceof \think\Paginator ) && $prize['desc']->isEmpty()))): ?><?php echo $prize['desc']; endif; ?></textarea>
        </div>
      </div>
