<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:57:"D:\mywork\lotgame\public/../app/front\view\user\edit.html";i:1553952512;s:51:"D:\mywork\lotgame\app\front\view\public\header.html";i:1553911713;s:47:"D:\mywork\lotgame\app\front\view\user\left.html";i:1553924708;s:51:"D:\mywork\lotgame\app\front\view\public\footer.html";i:1553934667;}*/ ?>
<!DOCTYPE html>
<html>
<head>
				...
				<div class="ibox-content">
					...
					<form  method="post" enctype="multipart/form-data">
						<ul class="edit-ul">
							...
							<li>
								<label>昵称：</label>
								<input type="text" class="edit-input" name="tbUserNick" value="<?php echo $user['username']; ?>" >
								<span class="help-text">必填</span>
							</li>
							<li>
								<label>性别：</label>
								<select class="edit-select" name="tbUserGender" id="tbUserGender">
							...
							<li>
								<label>生日：</label>
								<!-- <select class="edit-select birth-select" name="tbBirthYear" id="tbBirthYear" style="padding-left:10px;"> </select>
								<select class="edit-select birth-select" name="tbBirthMonth" id="tbBirthMonth" style="padding-left:10px;"> </select>
								<select class="edit-select birth-select" name="tbBirthDay" id="tbBirthDay" style="padding-left:10px;"> </select> -->
								<select class="edit-select birth-select" name="tbBirthYear" id="tbBirthYear" rel="2000"></select>年
						        <select class="edit-select birth-select" name="tbBirthMonth" id="tbBirthMonth" rel="2"></select>月
						        <select class="edit-select birth-select" name="tbBirthDay" id="tbBirthDay" rel="14"></select>日
							</li>
							<li>
								<label>QQ：</label>
								<input type="text" class="edit-input"  name="tbUserQQ" id="tbUserQQ" onblur="qq_blur(this)"  value="">
								<span class="help-text">设置后不可修改</span>
							</li>
							<li style="position: relative;left: -10px;">
								<label style="width: 60px;">支付宝：</label>
								<input type="text" class="edit-input" onblur="addr_blur(this)" id="tbAlipay" value=""  name="tbAlipay">
								<span class="help-text">设置后不可修改</span>
							</li>
							<li style="margin: 5px 0;">
								<label></label>
								<button class="user-btn" lay-submit lay-filter="formUser">保存内容</button>
							</li>
						</ul>
					</form>
				</div>
